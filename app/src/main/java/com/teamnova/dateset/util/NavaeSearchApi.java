...
public class NavaeSearchApi {
    /*public static void main(String[] args) {
        String clientId = "ksRf5zOEE4H2MHp3jBr1"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "L_0OxHM0RZ"; //애플리케이션 클라이언트 시크릿값"
    ...
    public String get(String apiUrl, Map<String, String> requestHeaders){
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) { // 정상 호출
                String info = readBody(con.getInputStream());
